...
/**
 * Escribe un programa que lea el fichero fruta.xml creado en el Ejercicio 1 y muestre el nombre, el color y
 * la cantidad de la fruta en la consola.
 */
public class Ejer2_LeerXML {
